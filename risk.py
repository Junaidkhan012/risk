...
class Main:
	def __init__(self):
     ...
     _______     _____      ___       _     ___________   
     `MM`MM'     `M`MM\     `M'      dM.    `MM`MMMMMMMb. 
      MM MM       M MMM\     M      ,MMb     MM MM    `Mb 
      MM MM       M M\MM\    M      d'YM.    MM MM     MM 
      MM MM       M M \MM\   M     ,P `Mb    MM MM     MM 
      MM MM       M M  \MM\  M     d'  YM.   MM MM     MM 
      MM MM       M M   \MM\ M    ,P   `Mb   MM MM     MM 
      MM MM       M M    \MM\M    d'    YM.  MM MM     MM 
(8)   MM YM       M M     \MMM   ,MMMMMMMMb  MM MM     MM 
((   ,M9  8b     d8 M      \MM   d'      YM. MM MM    .M9 
 YMMMM9    YMMMMM9 _M_      \M _dM_     _dMM_MM_MMMMMMM9' 
      ══════════════════════                              
     YOUR MIND IS A BEST WEAPON
 ══════════════════════
\033[1;90m══════════════════════════════════════════════════
...
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mWARNING  : AKHIR MOOT
\033[1;90m══════════════════════════════════════════════════
    """)
		print("%s [%s•%s] %sTOOL NAME : %sPINDALAY"%(G,R,G,B,G))
		print("%s [%s•%s] %sVERSION   : %s1.0"%(G,R,G,B,G))
		print("")
		print("\n    \033[0;92m            UID🔥 CLONING🔥 CP IDZ OPEN AFTER 7 DAYS OR JUST NOW \033[0;97m ")
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s[>_] [BY] : %s/%s -> \033[0;92m [ JZ-OK:%s ]- \033[0;91m[JZ-CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
